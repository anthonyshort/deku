...
exports.create = function(id){
  ...
  this.component = this.node.create();
  // recursively call create
  var html = this.component.create(id);
  return html;
};
...
exports.invalidate = function(){
  ...
  // TODO: instead of `update`, make it push into global rendering queue.
  // this.renderer.invalidate(this);
  this.enqueue(this.update);
};
