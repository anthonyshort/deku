...
exports.create = function(root, path){
  ...
  // This is happening also in `new VirtualNode`, children.map(setParent).
  this.node.parent = this.owner;
  this.owner.children[0] = this.node;
  this.node.create(this.root, this.path); // recurse
