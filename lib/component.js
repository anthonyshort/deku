...
function Component(opts) {
  ...
  // add default layer
  if (!this.layers.main) this.layers.main = {};
  if (!this.layers.main.template) this.layers.main.template = noop;
}
...
Component.prototype.render = function(state, props, send){
  return this.layers.main.template.call(null, state, props, send);
};
