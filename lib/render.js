...
function render (app, container) {
  ...
  function unmountEntity (entityId) {
    ...
    if (!entity) return
    trigger('beforeUnmount', entity, [entity.props, entity.nativeElement])
  ...
  function flushMountQueue () {
    while (mountQueue.length > 0) {
      ...
      var entity = entities[entityId]
      trigger('afterRender', entity, [entity.props, entity.nativeElement])
      trigger('afterMount', entity, [entity.props, entity.nativeElement])
    }
  }
  ...
  function updateEntityProps (entityId, nextProps) {
    var entity = entities[entityId]
    entity.props = defaults({}, nextProps, entity.component.defaultProps || {})
    trigger('validate', entity, [entity.props])
  }
...
function Entity (component, props, ownerId) {
  return {
    ...
    ownerId: ownerId,
    component: component,
    props: defaults(props || {}, component.defaultProps || {}),
    virtualElement: null,
    nativeElement: null
  }
}