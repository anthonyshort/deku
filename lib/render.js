...
function render (app, container) {
  ...
  function flushMountQueue () {
    while (mountQueue.length > 0) {
      ...
      trigger('afterMount', entity, [entity.context, entity.nativeElement])
    }
  }
  ...
  function updateEntity (entityId) {
    ...
    trigger('beforeUpdate', entity, [entity.context, nextProps])
    ...
    trigger('afterUpdate', entity, [entity.context, previousProps])
  }
  ...
  function toNativeComponent (ownerId, path, vnode) {
    var entity = new Entity(vnode.type, assign({ children: vnode.children }, vnode.attributes), ownerId)
