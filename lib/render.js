...
export default function render (app, container) {
  ...
  function toNative (entityId, path, vnode) {
    switch (nodeType(vnode)) {
      ...
      case 'component':
        let {nativeElement} = toNativeComponent(entityId, path, vnode)
  ...
  function toNativeComponent (ownerId, path, vnode) {
    var entity = Entity(vnode.type, { ...vnode.attributes, children: vnode.children }, ownerId)
  ...
  function diffChildren (path, entityId, prev, next, el) {
    ...
    var currentChildren = { ...children[entityId] }
  ...
  function diffComponent (path, entityId, prev, next, el) {
    if (next.type !== prev.type) {
      ...
      if (targetId) {
        updateEntityProps(targetId, { ...next.attributes, children: next.children })
  ...
  function trigger (name, entity, args) {
    ...
    return entity.component[name](...args)
  }
