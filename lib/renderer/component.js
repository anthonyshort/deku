...
function ComponentRenderer(Component, props) {
  ...
  this.instance.on('change', bind(this, this.invalidate));
...
ComponentRenderer.prototype.invalidate = function(){
  this.dirty = true;
};

/**
 * Does this component need to be re-rendered
 *
 * @return {Boolean}
 */

ComponentRenderer.prototype.isDirty = function(){
