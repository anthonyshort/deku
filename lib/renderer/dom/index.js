...
function rendering(app) {
  ...
  function onmount(data) {
    ...
    app.root = new Entity(component, props);
  ...
  function constructEntity(entity) {
    ...
    for (var name in layers) {
      ...
      var virtualElement = layer.template.call(null, entity.props, entity.state, send);
    ...
    // main virtual element
    // var virtualElement = layers.main.template.call(null, entity.props, entity.state, send);
    // if (!virtualElement) virtualElement = virtualize.node('noscript');
    // entity.lifecycle = null;
    // create native element.
    // var nativeElement = toNative(entity.id, '0', virtualElement);

    entity.virtualElement = entity.layers.main.virtualElement;
    entity.nativeElement = entity.layers.main.nativeElement;
  ...
  function renderEntity(entity) {
    ...
    entity.lifecycle = 'render';
    var layers = component.layers;
    var result = layers.main.template.call(null, entity.props, entity.state, send);
