...
function dom(world) {
  ...
  function updateChildren(id) {
    var children = world.entities[id].children;
  ...
  function remove() {
    ...
    removeElement(id, '0', world.root.nativeElement);
    unmount(world.root);
  ...
  function removeElement(entityId, path, el) {
    var children = world.entities[entityId].children;
  ...
  function replaceElement(entity, path, el, vnode) {
    ...
    for (var id in world.entities) {
      if (world.entities[id].nativeElement === el) {
        world.entities[id].nativeElement = newEl;
      }
    }
  }
  ...
  function updateEntity(entity, path, vnode) {
    var entityId = entity.id;
    var childId = world.entities[entityId].children[path];
