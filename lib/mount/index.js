...
function Mount(Component, props) {
  ...
  this.el = this.toElement(this.component.current);
}
...
Mount.prototype.replaceNode = function(current, next) {
  var isRoot = (this.component.current === current);
  var container = this.el.parentNode;

  this.removeComponents(current);
  var newEl = this.toElement(next);
