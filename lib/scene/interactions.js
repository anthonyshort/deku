...
Interactions.prototype.bind = function(namespace, path, event, fn){
  var group = this.handlers[namespace] || (this.handlers[namespace] = {});
  var handlers = group[path] || (group[path] = {});
...
function handle(event){
  ...
  var paths = [target.__entity__, target.__path__, event.type];
