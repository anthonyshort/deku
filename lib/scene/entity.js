...
Entity.prototype.setAttribute = function(el, key, val){
  if (this.scene.interactions.isEvent(key)) {
    var self = this;
    return this.scene.interactions.bind(el.__path__, key, function(e){
      val.call(self.component, e, self.state, self.props);
    });
  }
...
Entity.prototype.removeAttribute = function(el, key){
  if (this.scene.interactions.isEvent(key)) {
    return this.scene.interactions.unbind(el.__path__, key);
  }
